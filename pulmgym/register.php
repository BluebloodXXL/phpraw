				...
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
                            ...
                            <div class="col-xs-4">
                                <a href="index.php" class="active" id="">PulmGym</a>
                            </div>
                            <div class="col-xs-4">
							...
							<div class="col-lg-12">
								...
								<form id="register-form" method="post" role="form" >
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="first_name" id="first_name" tabindex="1" class="form-control" placeholder="Fist Name" value="" required >
                                    </div>
